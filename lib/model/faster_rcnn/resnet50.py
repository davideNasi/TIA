...
class my_resnet50(_fasterRCNN):
    def __init__(self, classes, num_layers=50, pretrained=False, class_agnostic=False, context=True, num_aux1=2, num_aux2=2):
        self.model_path = "pretrained_models/resnet50.pth"
